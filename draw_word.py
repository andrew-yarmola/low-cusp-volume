...
class word_diagram(Tk) :
    ...
    def initialize(self) :
        ...
        self.max_dist = max([1] + list(map(lambda x : gen_total_power(x[1],'M'), self.edges)) + list(map(lambda x : gen_total_power(x[1],'N'), self.edges))) 
